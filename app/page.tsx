          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                emoji: "⛏️",
                title: "3D 마인크래프트",
                desc: "블록을 부수고 설치하며 세계를 만들어라!",
                bg: "from-green-600 via-lime-500 to-emerald-700",
                href: "/minecraft3d",
              },
              {
                emoji: "🤖",
                title: "로봇 배틀",
                desc: "로봇을 조립하고 충전해서 싸워라!",
                bg: "from-slate-600 via-cyan-500 to-blue-700",
                href: "/robotbattle",
              },
              {
                emoji: "🏗️",
              ...
              },
              {
                emoji: "🕵️",
                title: "스파이 되기",
                desc: "비밀 요원이 되어 미션 수행!",
                bg: "from-gray-900 via-slate-800 to-green-900",
                href: "/spy",
              },
              {
                emoji: "🌌",
              ...
              },
              {
                ...
                title: "방탈출",
                desc: "5개의 방에서 탈출하라!",
                bg: "from-amber-800 via-stone-800 to-gray-900",
                href: "/roomescape",
              },
              {
                emoji: "🌟",
                title: "주인공 되기",
                desc: "네가 바로 이야기의 주인공!",
                bg: "from-yellow-500 via-pink-500 to-purple-600",
                href: "/protagonist",
              },
              {
                emoji: "🦇",
                title: "배트맨",
                desc: "고담시를 지키는 다크나이트!",
                bg: "from-gray-900 via-slate-800 to-yellow-900",
                href: "/batman",
              },
              {
                emoji: "🎰",
              ...
              },
              {
                emoji: "🦔",
                title: "고슴도치 대전",
                desc: "가시로 승부한다! 최강 고슴도치!",
                bg: "from-amber-700 via-stone-700 to-amber-800",
                href: "/hedgehog",
              },
              {
                emoji: "🐉",
                title: "닌자고 드래곤 라이징",
                desc: "드래곤과 함께 닌자고를 구하라!",
                bg: "from-red-700 via-orange-700 to-yellow-700",
                href: "/dragonrising",
              },
              {
                emoji: "🎮",
                title: "게임 만들기",
                desc: "나만의 게임을 개발하고 출시하자!",
              ...
              },
              {
                emoji: "👨‍🍳",
                title: "레시피 만들기",
                desc: "재료를 조합해 요리를 발견하자!",
                bg: "from-orange-600 via-red-600 to-amber-600",
                href: "/recipe",
              },
              {
                emoji: "🧟",
                title: "좀비 서바이벌",
                desc: "살아남아라. 그것이 전부다.",
                bg: "from-gray-800 via-red-900 to-gray-900",
                href: "/zombie",
              },
              {
                emoji: "⚔️🐉",
                title: "초현실 RPG",
                desc: "체온, 허기, 날씨까지 현실적 RPG!",
                bg: "from-indigo-800 via-purple-800 to-gray-900",
                href: "/rpglife",
              },
              {
                emoji: "💚⚔️",
                title: "닌자고 시즌 2",
                desc: "그린 닌자의 전설! 오버로드를 막아라!",
                bg: "from-green-700 via-emerald-800 to-purple-900",
                href: "/ninjago2",
              },
              {
                emoji: "🤖⚔️",
                title: "닌자고 시즌 3",
                desc: "닌드로이드의 역습! 디지털 전쟁!",
                bg: "from-cyan-700 via-purple-800 to-gray-900",
                href: "/ninjago3",
              },
              {
                emoji: "🏆⚔️",
                title: "닌자고 시즌 4",
                desc: "원소의 토너먼트! 첸의 섬!",
                bg: "from-orange-700 via-amber-800 to-red-900",
                href: "/ninjago4",
              },
              {
                emoji: "👻🌪️",
                title: "닌자고 시즌 5",
                desc: "유령의 시간! 모로의 저주!",
                bg: "from-green-800 via-gray-800 to-green-900",
                href: "/ninjago5",
              },
              {
                emoji: "🧞🏴‍☠️",
                title: "닌자고 시즌 6",
                desc: "스카이바운드! 하늘 해적!",
                bg: "from-sky-700 via-blue-800 to-amber-800",
                href: "/ninjago6",
              },
              {
                emoji: "⏰⚔️",
                title: "닌자고 시즌 7",
                desc: "시간의 손! 시간 쌍둥이!",
                bg: "from-red-800 via-stone-800 to-amber-900",
                href: "/ninjago7",
              },
              {
                emoji: "😈🏍️",
                title: "닌자고 시즌 8",
                desc: "가마돈의 아들들! 하루미의 배신!",
                bg: "from-purple-800 via-gray-900 to-red-900",
                href: "/ninjago8",
              },
              {
                emoji: "🐉⛓️",
              ...
              },
              {
                ...
                title: "닌자고 시즌 10",
                desc: "오니의 행진! 최후의 전투!",
                bg: "from-yellow-700 via-gray-900 to-purple-900",
                href: "/ninjago10",
              },
              {
                emoji: "⚔️💀",
                title: "던전 서바이버",
                desc: "실시간 액션 로그라이크! 차원이 다른 게임!",
                bg: "from-cyan-700 via-purple-800 to-black",
                href: "/dungeon",
              },
              {
                emoji: "🚀🔫",
                title: "스페이스 슈터",
                desc: "실시간 슈팅! 탄막을 피하고 쏴라!",
                bg: "from-indigo-800 via-black to-purple-900",
                href: "/spaceshooter",
              },
              {
                emoji: "🏃💨",
                title: "플랫포머",
                desc: "점프하고 달려라! 실시간 액션!",
                bg: "from-sky-600 via-green-700 to-emerald-800",
                href: "/platformer",
              },
              {
                emoji: "🏰🗼",
                title: "타워 디펜스",
                desc: "타워를 세우고 적을 막아라!",
                bg: "from-amber-700 via-stone-800 to-gray-900",
                href: "/towerdefense",
              },
              {
                emoji: "🥊🔥",
                title: "격투 게임",
                desc: "실시간 1대1 대전! K.O!",
                bg: "from-red-700 via-orange-800 to-gray-900",
                href: "/fighter",
              },
              {
                emoji: "🤖⚔️",
                title: "트랜스포머",
                desc: "변신하고 싸워라! 실시간 액션!",
                bg: "from-red-700 via-blue-800 to-gray-900",
                href: "/transformer",
              },
              {
                emoji: "🥷🐉",
                title: "닌자고 울트라",
                desc: "초고퀄! 스핀짓주+드래곤 실시간 액션!",
                bg: "from-red-600 via-yellow-600 to-green-700",
                href: "/ninjagoultra",
              },
              {
                emoji: "💰",
                title: "부자 되기",
                desc: "알바생에서 억만장자까지!",
                bg: "from-yellow-600 via-amber-700 to-orange-700",
                href: "/richlife",
              },
              {
                emoji: "📱",
                title: "앱 스튜디오",
                desc: "초현실 앱 개발 시뮬레이션!",
                bg: "from-cyan-700 via-purple-700 to-indigo-800",
                href: "/appstudio",
              },
              {
                emoji: "🚀🔪",
                title: "어몽어스 (WASD)",
                desc: "진짜 WASD로 움직이는 어몽어스!",
                bg: "from-red-700 via-gray-900 to-blue-800",
                href: "/amongus2",
              },
              {
                emoji: "🐍",
              ...
              },
              {
                ...
                title: "좀비 슈터",
                desc: "탑다운 실시간 좀비 슈터!",
                bg: "from-gray-800 via-red-900 to-green-900",
                href: "/zombie2",
              },
              {
                emoji: "👁️⚔️",
                title: "주술회전 울트라",
                desc: "실시간 격투! 영역전개!",
                bg: "from-indigo-800 via-purple-900 to-black",
                href: "/jujutsu2",
              },
              {
                emoji: "⛏️🌍",
                title: "마인크래프트 2D",
                desc: "캔버스 샌드박스! 블록을 깨고 세워라!",
                bg: "from-green-700 via-brown-700 to-sky-600",
                href: "/minecraft2",
              },
              {
                emoji: "🏃💨",
                title: "도망치기 울트라",
                desc: "실시간 추격전! 살아남아라!",
                bg: "from-blue-700 via-red-800 to-gray-900",
                href: "/chase2",
              },
              {
                emoji: "🏪",
                title: "편의점 사장",
                desc: "편의점을 운영하고 매출을 올려라!",
              ...
              },
              {
                emoji: "🌾",
                title: "농장 키우기",
                desc: "작물 심고 동물 키우며 농장을 확장하라!",
                bg: "from-green-500 via-emerald-600 to-yellow-500",
                href: "/farm",
              },
              {
                emoji: "🐾",
                title: "동물 병원",
                desc: "수의사가 되어 아픈 동물을 치료하라!",
                bg: "from-pink-400 via-rose-500 to-red-400",
                href: "/hospital",
              },
              {
                emoji: "☕",
                title: "카페 운영",
                desc: "나만의 카페에서 음료와 디저트를 만들자!",
                bg: "from-amber-600 via-orange-500 to-yellow-500",
                href: "/cafe",
              },
              {
                emoji: "🎯",
                title: "반응속도 테스트",
                desc: "초록색이 되면 최대한 빨리 클릭!",
                bg: "from-green-500 to-emerald-600",
                href: "/reaction",
              },
              {
              ...
              },
              {
                emoji: "⌨️",
                title: "타자 디펜스",
                desc: "떨어지는 단어를 타이핑해서 파괴!",
                bg: "from-slate-600 to-cyan-600",
                href: "/typing",
              },
              {
                emoji: "✖️",
                title: "구구단 챌린지",
                desc: "얼마나 빠르게 풀 수 있을까?",
                bg: "from-amber-500 to-orange-600",
                href: "/multiply",
              },
              {
